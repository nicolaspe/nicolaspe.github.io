...
<figure style="text-align: center">
	<img class="p_capture" width="70%" src="./peacef_overview.jpg" alt="Peaceful Forest Overview">
...
<div style="display: flex;">
	<figure class="vid_container vid_720x2" style="text-align: center;" width="40%">
		<video src="./peaceDark_clip01.webm" class="vid_doc" autoplay loop width="40%" />
	</figure>
	<figure class="vid_container vid_720x2" style="text-align: center;" width="40%">
		<video src="./peaceDark_clip03.webm" class="vid_doc" autoplay loop />
	</figure>
</div>
...
<figure style="text-align: center">
	<img class="p_capture" width="70%" src="./peacef_water.jpg" alt="Peaceful Forest waterside">
	<figcaption>Forest's waterside</figcaption>
</figure>

<div style="display: flex;">
	<figure class="vid_container vid_720x2" style="text-align: center;" width="40%">
		<video src="./peaceDark_clip05.webm" class="vid_doc" autoplay loop width="40%" />
	</figure>
	<figure class="vid_container vid_720x2" style="text-align: center;" width="40%">
		<video src="./peaceDark_clip04.webm" class="vid_doc" autoplay loop />
	</figure>
</div>
